...
#ifndef SOAP_TYPE_WSwrapper_byte
#define SOAP_TYPE_WSwrapper_byte (2)
#endif
...
#ifndef SOAP_TYPE_WSwrapper_int
#define SOAP_TYPE_WSwrapper_int (1)
#endif
...
#ifndef SOAP_TYPE_WSwrapper_double
#define SOAP_TYPE_WSwrapper_double (6)
#endif
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__getsnr(struct soap*, struct ns__getsnr *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__getsnr(struct soap*, const struct ns__getsnr *);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__getsnr(struct soap*, const struct ns__getsnr *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__getsnr(struct soap*, const char*, int, const struct ns__getsnr *, const char*);
SOAP_FMAC3 struct ns__getsnr * SOAP_FMAC4 soap_get_ns__getsnr(struct soap*, struct ns__getsnr *, const char*, const char*);
SOAP_FMAC3 struct ns__getsnr * SOAP_FMAC4 soap_in_ns__getsnr(struct soap*, const char*, struct ns__getsnr *, const char*);
SOAP_FMAC5 struct ns__getsnr * SOAP_FMAC6 soap_new_ns__getsnr(struct soap*, int);
SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns__getsnr(struct soap*, struct ns__getsnr*);
SOAP_FMAC3 struct ns__getsnr * SOAP_FMAC4 soap_instantiate_ns__getsnr(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__getsnr(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_WSwrapper_ns__getsnrResponse
#define SOAP_TYPE_WSwrapper_ns__getsnrResponse (10)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__getsnrResponse(struct soap*, struct ns__getsnrResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__getsnrResponse(struct soap*, const struct ns__getsnrResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__getsnrResponse(struct soap*, const struct ns__getsnrResponse *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__getsnrResponse(struct soap*, const char*, int, const struct ns__getsnrResponse *, const char*);
SOAP_FMAC3 struct ns__getsnrResponse * SOAP_FMAC4 soap_get_ns__getsnrResponse(struct soap*, struct ns__getsnrResponse *, const char*, const char*);
SOAP_FMAC3 struct ns__getsnrResponse * SOAP_FMAC4 soap_in_ns__getsnrResponse(struct soap*, const char*, struct ns__getsnrResponse *, const char*);
SOAP_FMAC5 struct ns__getsnrResponse * SOAP_FMAC6 soap_new_ns__getsnrResponse(struct soap*, int);
SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns__getsnrResponse(struct soap*, struct ns__getsnrResponse*);
SOAP_FMAC3 struct ns__getsnrResponse * SOAP_FMAC4 soap_instantiate_ns__getsnrResponse(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__getsnrResponse(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef WITH_NOGLOBAL

#ifndef SOAP_TYPE_WSwrapper_PointerToSOAP_ENV__Reason
#define SOAP_TYPE_WSwrapper_PointerToSOAP_ENV__Reason (21)
#endif
...
#ifndef SOAP_TYPE_WSwrapper_PointerToSOAP_ENV__Detail
#define SOAP_TYPE_WSwrapper_PointerToSOAP_ENV__Detail (20)
#endif
...
#ifndef SOAP_TYPE_WSwrapper_PointerToSOAP_ENV__Code
#define SOAP_TYPE_WSwrapper_PointerToSOAP_ENV__Code (16)
#endif
...
#ifndef SOAP_TYPE_WSwrapper_string
#define SOAP_TYPE_WSwrapper_string (3)
#endif
